...
#define DOUT 40  /* Data out pin (T_DO) of touch screen */
#define DIN  41  /* Data in pin (T_DIN) of touch screen */
#define DCS  42  /* Chip select pin (T_CS) of touch screen */
#define DCLK 43  /* Clock pin (T_CLK) of touch screen */
