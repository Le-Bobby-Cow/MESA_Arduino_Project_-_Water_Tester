...
#define DOUT 44  /* Data out pin (T_DO) of touch screen */
#define DIN  45  /* Data in pin (T_DIN) of touch screen */
#define DCS  46  /* Chip select pin (T_CS) of touch screen */
#define DCLK 47  /* Clock pin (T_CLK) of touch screen */
